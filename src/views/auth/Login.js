            ...
            <div className="w-[98%] mx-2 sm:mx-0 sm:w-[500px] bg-white rounded-lg text-black mt-3 px-4 py-6">
                <Form onSubmit={(e) => submitHandler(e)}>
                    ...
                    <FormGroup className="flex flex-col ">
                        <label className="px-1 py-1 font-semibold ">
                            Email
                        </label>
                        <input
                    ...
                    <FormGroup className="flex flex-col">
                        ...
                        <span
                            className="mx-2 cursor-pointer relative bottom-7 left-[93%]"
                    ...
                    <Button
                        type="submit"
                        className="py-3 border-0 text-white btn w-100 sign-up-button mt-10"
                        color="info"
                    >
                        Login
                    </Button>
